    ...
    const fetchUserProfile = async () => {
        try {
            ...
            if (response.data.success) {
                ...
                setData((prev) => ({
                    ...prev,
                    firstName: address.firstName || nameParts.firstName || prev.firstName,
                    lastName: address.lastName || nameParts.lastName || prev.lastName,
            ...
            toast.error("Unable to load your saved details");
        }
    }
